	...
	<div class="container-fluid mw-xl hero-block-content pb-sm-4">
		<div class="row h-100">
			<div class="col-md-7 text-start my-sm-3 my-4 text-white ">
												...
												<h1 class="hero-title display-1"><?php echo e($title); ?></h1>						
				<div class="d-none d-sm-block">
											<div class="hero-block-description py-3 h5"><?php echo e($copy); ?></div>
...
<?php /**PATH C:\bkupp\lokl\repo\fortune-3\resources\views/service-header.blade.php ENDPATH**/ ?>