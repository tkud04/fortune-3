...
<?php $__env->startSection('title',"Paid Media"); ?>
...
$sh = [
  'subtitle' => "Paid Media",
  'title' => "Outperform with paid media.",
  'copy' => "Our holistic digital strategies, proprietary insights, and granular targeting accelerate growth and outmaneuver your competition."
];

$sl = [
  'title_1' => "what we do",
  'title_2' => "Develop a customized, full-funnel media mix to amplify ad budget and outperform in your market.",
  'title_3' => "",
  'list' => [
  ['title' => "Paid Search",'copy' => "Reach brand-aware consumers at the right moment with targeted and actionable advertising. Engage prospects or increase brand loyalty with exact audience targeting — down to just one household."],
  ['title' => "Paid Social",'copy' => "Build and nurture a relationship between your brand and best customers using surround-sound social media strategies and top-performing organic creative."],
  ['title' => "Shopping",'copy' => "Reach loyal and new customers through holistic product campaigns and integrated strategies at every decision touchpoint."],
  ['title' => "Amazon + Retail",'copy' => "Be first in line to meet your ideal customers with our expert team and enterprise-level data partnerships."],
  ['title' => "Video + OTT",'copy' => "Gain brand awareness with new audiences and develop transparent, performance-driven advertising."],
  ]
];
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\fortune-3\resources\views/service-paid-media.blade.php ENDPATH**/ ?>