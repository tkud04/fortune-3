...
<div style="height:50px" aria-hidden="true" class="wp-block-spacer"></div>
	...
	<style>		
				...
				background: #7c0f81;
							...
							#block_60b04e256bbbb .text-box {
				color: #ffffff;
			}
				
	</style>

</div></div><section id="block_60b04e256bbbb" class="content-block  alignfull testimonial-block testim_type-text py-5 my-4 background-7c0f81 has-font-color text-default">	<div class="container-fluid mw-xl">
		<div class="row  align-items-stretch testim-row">
			...
			<div class="col-md-10 offset-md-1 text-box py-md-5 py-4 my-auto">
				<div class="row add-bord">
					...
					<div class="col-md-10">
						<div class="h3">“<?php echo e($copy); ?>”</div>
													<div class="pt-4">
								<div class="pb-2"><b><?php echo e($name); ?></b></div>
								<div class=""><?php echo e($position); ?></div>
							</div>
...
</section><?php /**PATH C:\bkupp\lokl\repo\fortune-3\resources\views/service-testimonial.blade.php ENDPATH**/ ?>