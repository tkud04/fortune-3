			  ...
			  <?php
				...
				<div class="col-md-4 link-box detailed-what text-start mb-md-0 mb-3 ww-active">
					<a class="long-arrow" href="{{$s['href']}}" target="_self">
																						...
																						<div class="h4 text-start titillium-web">{{$s['title']}}</div> 
																																		<div class="mt-2 text-base small-font">{{$s['text']}}</div> 
...
<section id="block_603c3f13c5660" class="content-block  alignfull content-grid py-0 my-0 has-font-color text-default">
		...
		<a href="{{$w['href']}}" class="grid-link" ><span class="visually-hidden">{{$w['title']}}</span></a>		
					<div class="image-background" aria-hidden="true">
				<picture class="zoom-img">
<source type="image/webp" data-lazy-srcset="{{$w['img']}} 461w, {{$w['img']}} 408w, {{$w['img']}} 204w" srcset="data:image/svg+xml,%3Csvg%20xmlns=&#039;http://www.w3.org/2000/svg&#039;%20viewBox=&#039;0%200%20461%20452&#039;%3E%3C/svg%3E" data-lazy-sizes="(max-width: 461px) 100vw, 461px"/>
<img width="461" height="452" src="data:image/svg+xml,%3Csvg%20xmlns=&#039;http://www.w3.org/2000/svg&#039;%20viewBox=&#039;0%200%20461%20452&#039;%3E%3C/svg%3E" alt="{{$w['title']}}" data-lazy-srcset="{{$w['img']}} 461w, {{$w['img']}} 408w, {{$w['img']}} 204w" data-lazy-sizes="(max-width: 461px) 100vw, 461px" data-lazy-src="{{$w['img']}}"/>
</picture>
<noscript><picture class="zoom-img">
<source type="image/webp" srcset="{{$w['img']}} 461w, {{$w['img']}} 408w, {{$w['img']}} 204w" sizes="(max-width: 461px) 100vw, 461px"/>
<img width="461" height="452" src="" alt="{{$w['title']}}" srcset="{{$w['img']}} 461w, {{$w['img']}} 408w, {{$w['img']}} 204w" sizes="(max-width: 461px) 100vw, 461px"/>
</picture>
</noscript>			</div>
		...
		<div class="text-start text-white grid-over">	
			<div class="p-3 copy-holder">
									<p class="gr-t mb-lg-4 mb-3 titillium-web font-weight-normal">{{$w['title']}}</p>
													<div class="gr-sub display-2 text-white mb-lg-4 mb-3">{{$w['big_caption']}}</div>
													<p class="gr-cat text-start grid-cat pe-lg-5 me-lg-5">{{$w['small_caption']}}</p>
											</div>	
		</div>		
	</div>
												</div>	
