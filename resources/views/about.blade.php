...
<img width="700" height="600" src="{{$banner}}" alt="About Us" aria-hidden="true" loading="eager" srcset="{{$banner}} 700w, {{$banner}} 467w, {{$banner}} 233w" sizes="(max-width: 700px) 100vw, 700px"/>
	...
	<div class="container-fluid mw-xl hero-block-content pt-sm-5 mt-sm-5">
		<div class="row h-100">
			<div class="col-md-7 text-start my-sm-3 my-4 text-white pb-md-5">
												...
												<h1 class="hero-title display-1">Performance is who we are.</h1>						
				<div class="d-none d-sm-block">
											<div class="hero-block-description py-3 h5">We live and breathe digital services powered by data. What drives us is making a lasting impact on your growth. </div>
	...
	<div class="d-sm-none d-block has-bg-color background-000000 text-white hbc-second">
		<div class="container-fluid mw-xl hero-block-content py-4">
							...
							<div class="h5">
					We live and breathe digital services powered by data. What drives us is making a lasting impact on your growth. 				</div>
								</div>
	</div>
<div><div class="container-fluid mw-xl">

<section id="block_607cd93190730" class="content-block  alignwide wp-block-acf-info-block alignwide info-block py-md-5 py-4 has-font-color text-default">	<div class="container-fluid mw-xl">
		<div class="row py-md-2 ">
			...
			<div class="col-md-6 py-md-4">
													<div class="mb-0 px-md-2 py-md-0 py-4 text-base"><p>Digital consumers signal their individuality in all kinds of ways. We build winning marketing strategies based on a deep understanding of those consumers and what drives their decision-making across all channels.</p>
<p>Know who your customers are. Know where to find them. Know how to connect with them. Know if it’s working.</p>
<p>That’s how we amplify results and deliver award-winning digital advertising, SEO, social, analytics and digital creative services.</p>
</div>
																		<a class="animated-arrow pb-3 px-2 d-inline-block" href="https://www.amsivedigital.com/services/" target="_self"><b class="d-inline-block align-middle">Learn more</b><span class="svg-circle"><svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
									<defs>
...
</div></div><section id="block_607f901086210" class="content-block  alignfull wp-block-acf-office-box alignfull office-box my-0 background-f9f9f9 has-font-color text-default">	<div class="container-fluid mw-xl pt-5">
		<div class="row py-md-2">
			<div class="col-md-6 py-md-4 mb-md-0 mb-4">
				<div class="me-lg-5 pe-lg-5 pe-4">
											<div class="label">OUR OFFICES</div>
																<h2 class="display-2 mb-2">We’re here for you.</h2>
														</div>
			</div>
			<div class="col-md-6 py-md-4">
									<div class="row">					
...
</div></div><section id="block_604579092daf9" class="content-block pt-md-5 pt-3 alignfull wp-block-acf-our-team alignfull our-team my-4 has-font-color text-default">	<div class="container-fluid mw-xl">
				<div class="row">
			<div class="col-12 text-md-start text-center mb-4">
									<h2 class="mb-2">Leadership Team</h2>
											</div>
		</div>
							<div class="row align-items-stretch">
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0010_capolla.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0010_copolla-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Michael Coppola</b></h5>
															<div class="small-font text-base">President, Amsive</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0009_candulo.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0009_candulo-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Michael Candullo</b></h5>
															<div class="small-font text-base">Executive Vice President, Digital Operations</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0003_ruben.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0003_ruben-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Ruben Quinones</b></h5>
															<div class="small-font text-base">Senior Vice President, Sales</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0008_sarah.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0008_sarah-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Sarah Gray</b></h5>
															<div class="small-font text-base">Group Director, Organic Services</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0019_jenny.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0019_jenny-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Jenny Chan</b></h5>
															<div class="small-font text-base">Director, Finance &#038; Operations</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0021_james.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0021_james-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>James Connell</b></h5>
															<div class="small-font text-base">Group Director, Media Services</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0005_matt.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0005_matt-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Matt Perlman</b></h5>
															<div class="small-font text-base">Senior Vice President, Client Services</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0001_rich.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0001_rich-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Rich Campanero</b></h5>
															<div class="small-font text-base">Group Director, Business Development</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0007_lily2.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0007_lily2-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Lily Ray</b></h5>
															<div class="small-font text-base">Senior Director, SEO + Head of Organic Research</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0022_inna.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0022_inna-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Inna Zeyger</b></h5>
															<div class="small-font text-base">Senior Director, Digital Media</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles-asaf-BW.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles-asaf-color.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Asaf Shakham</b></h5>
															<div class="small-font text-base">Executive Creative Director</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0002_Caryn.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0002_Caryn-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Karen Koslow</b></h5>
															<div class="small-font text-base">Practice Lead, Influencer + Content Marketing</div>
													</div>
					</div>
									<div class="col-lg-3 col-md-4 col-6 text-start mb-3 single-member">
						<div class="py-md-3 px-1">
							<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0018_jein.jpg" class="image-background position-relative mb-3 rocket-lazyload" aria-hidden="true" style="">
																											<div data-bg="https://www.amsivedigital.com/wp-content/uploads/2021/04/Profiles_0018_jein-1.jpg" class="m-over image-background position-absolute rocket-lazyload" aria-hidden="true" style=""></div>
																								</div>
							<h5 class="mb-1"><b>Jein Funk</b></h5>
															<div class="small-font text-base">Associate Director, Content + Creative Strategy</div>
													</div>
					</div>
							</div>
			</div>
...
</div></div><section id="block_604584316b79a" class="content-block  alignfull wp-block-acf-about-us alignfull about-us pt-3 pb-3 background-ffffff has-font-color text-default">	<div class="container-fluid mw-xl">
		<div class="row py-md-2">
			<div class="col-md-6 pt-md-3">
				<div class="me-md-5 pe-md-5">
													<h2 class="cta-title display-2">Come see what we&#039;re about.</h2>						
								</div>
			</div>
			<div class="col-md-6 pt-md-3">
													<div class="mb-0 px-2 py-md-0 pt-4"><p>Diverse, inclusive, and growing — we work together to bring the best out of ourselves, our team, and our client outcomes. </p>
</div>
							</div>			
		</div>
